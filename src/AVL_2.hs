...
balanced Nil = True
balanced (Tree _ n l r) = rk r < n && n <= rk r + 2 
                       && rk l < n && n <= rk l + 2 
                       && (balanced l)
                       && (balanced r)
...
-- balanced' :: Tree a -> Bool
-- balanced' Nil = True
-- balanced' (Tree v _ l r) = ((ht l) <= (ht r) + 1)
--                       && (ht r <= ht l + 1)
--                       && (balanced' l)
--                       && (balanced' r)
