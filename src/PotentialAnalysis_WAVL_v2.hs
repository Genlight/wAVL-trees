...
{-@ fmapRotateRight :: {t:NEWavl | isNode1_2 t} -> {l:Tick ({l':NEWavl | isNode1_2 l' }) | rk (tval l) == rk t && amortized1 (left t) l}
...
{-@ inTreeL :: t:NEWavl -> {l:Tick ({l':NEWavl | (rkDiff l' (left t) 0 || rkDiff l' (left t) 1)}) | rk (tval l) < rk t &&
