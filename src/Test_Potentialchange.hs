...
--           -> {t:NEWavl | EqRk v t } @-}
{-@ rotateRight :: {v:Node0_2 | IsNode1_2 (left v) } -> {t:NEWavl | EqRk v t && isNode1_1 t } @-}
...
{-@ rotateDoubleRight :: {v:Node0_2 | IsNode2_1 (left v) } -> {t:NEWavl | EqRk v t && isNode1_1 t } @-}
...
{-@ rotateLeft :: {v:Node2_0 | IsNode2_1 (right v) } -> {t:NEWavl | EqRk v t && isNode1_1 t && potT2 v + 2 == potT t} @-}
rotateLeft :: Tree a -> Tree a
rotateLeft t@(Tree x n a (Tree y m b c)) = Tree y m (Tree x (n-1) a b) c

{-@ rotateDoubleLeft :: {v:Node2_0 | IsNode1_2 (right v) } 
          -> {t:NEWavl | EqRk v t && isNode1_1 t && (potT2 v + 2 == potT t || potT2 v + 1 == potT t)} @-}
